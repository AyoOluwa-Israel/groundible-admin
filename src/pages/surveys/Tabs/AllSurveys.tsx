import { TAllSurveys, TColumn } from "@/types/SurveyTypes";
                ...
                >
                  ...
                  {columns?.map((col, i) => (
                    <td key={i} className={`pl-2 text-sm font-normal`}>
                      {row[col.field as keyof TAllSurveys]}
                    </td>
                  ))}
                  {/* </Link> */}
                </tr>
